...
_Note_: 
Before answering the following questions, make sure to compile the document to 
make sure that everything is working properly.
As you answer each question, compile after each question to make sure you are 
...
you will receive a zero—for the assignment and possibly for the course.
...
### __Q10: Does there seem to be any evidence of heteroskedasticity in this relationship? Plot the residuals from your previous regression at different levels of school attendence and interpret. __
...
### __Q13: Test the joint hypothesis at the 95% level that the coefficients on `AGE` and `i_economics` are equal to zero. Clearly state the null and alternative hypotheses.__

```{r}
# Write your code here
```

### __Q14: Regress income on school attainment and the interaction between school attainment and the degree category of your choice. __
...
### __Q15: In this dataset, does it seem like some degrees have better returns to lifetime income than others?__

  - Make sure to cite your estimate results and explain why they support 
  your claim.
  
### __Q16: What are some reasons why your estimates may not be enough to answer the question of whether degree type actually has a *causal* effect on the returns to education? __
